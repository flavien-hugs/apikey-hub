...
class APIKeyFilterSchema(BaseModel):
    user_id: Optional[Union[str, PydanticObjectId]] = Field(
        None, description="The user ID that the API key belongs to")
    is_active: Optional[bool] = Field(
        None, title="Is Active", description="Whether the API key is active or not")
